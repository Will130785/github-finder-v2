...
},{"../core-js/object/define-property":"../node_modules/@babel/runtime-corejs2/core-js/object/define-property.js"}],"../src/models/Search.js":[function(require,module,exports) {
"use strict";
...
var Search = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Search, [{
    key: "searchUsers",
    value: function () {
      var _searchUsers = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee(user) {
        var profileResponse, repoResponse, profileData, repoData;
...
},{"@babel/runtime-corejs2/regenerator":"../node_modules/@babel/runtime-corejs2/regenerator/index.js","@babel/runtime-corejs2/helpers/asyncToGenerator":"../node_modules/@babel/runtime-corejs2/helpers/asyncToGenerator.js","@babel/runtime-corejs2/helpers/classCallCheck":"../node_modules/@babel/runtime-corejs2/helpers/classCallCheck.js","@babel/runtime-corejs2/helpers/createClass":"../node_modules/@babel/runtime-corejs2/helpers/createClass.js"}],"../src/views/searchView.js":[function(require,module,exports) {
"use strict";
...
var UI = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(UI, [{
    key: "displayProfile",
    value: function displayProfile(data) {
      var html = "\n        <div class=\"card profile__card\">\n            <h2>".concat(data.profileData.name, "</h2>\n            <div class=\"profile__content\">\n                <div class=\"profile__content--pic\">\n                    <img class=\"profile__content--pic-img\" src=").concat(data.profileData.avatar_url, ">\n                    <a href=").concat(data.profileData.html_url, " target=\"_blank\" class=\"btn btn-lg btn-warning profile__content--btn\">View Profile</a>\n                </div>\n\n                <div class=\"profile__content--info\">\n                    <span class=\"display-btn display-btn--1\">Public Repos: <span id=\"repos\">").concat(data.profileData.public_repos, "</span></span>\n                    <span class=\"display-btn display-btn--2\">Public Gists: <span id=\"repos\">").concat(data.profileData.public_gists, "</span></span>\n                    <span class=\"display-btn display-btn--3\">Public Followers: <span id=\"repos\">").concat(data.profileData.followers, "</span></span>\n                    <span class=\"display-btn display-btn--4\">Public Public Following: <span id=\"repos\">").concat(data.profileData.following, "</span></span>\n\n                    <p class=\"profile__content--company\">Company: <span id=\"company\">").concat(data.profileData.company, "</span></p>\n                    <p class=\"profile__content--web\">Website/Blog: <span id=\"web\">").concat(data.profileData.blog, "</span></p>\n                    <p class=\"profile__content--location\">Location: <span id=\"location\">").concat(data.profileData.location, "</span></p>\n                    <p class=\"profile__content--company\">Member Since: <span id=\"member\">").concat(data.profileData.created_at, "</span></p>\n                </div>\n            </div>\n        </div>\n\n        <h2>Latest Repos</h2>\n        <div class=\"repos\">\n        </div>\n        ");
      this.profile.innerHTML = html;
    } //Method to display User repos to UI

  }, {
    key: "displayRepos",
    value: function displayRepos(data) {
      var output = "";
      console.log(data);
      data.forEach(function (repo) {
        output += "\n                <div class=\"repo\">\n                    <div class=\"repo__title\">\n                        <p>".concat(repo.name, "</p>\n                    </div>\n                <div class=\"repo__display\">\n                    <span class=\"display-btn display-btn--2\">Stars: <span id=\"stars\">").concat(repo.stargazers_count, "</span></span>\n                    <span class=\"display-btn display-btn--3\">Watchers: <span id=\"watchers\">").concat(repo.watchers_count, "</span></span>\n                    <span class=\"display-btn display-btn--4\">Forks: <span id=\"forks\">").concat(repo.forks_count, "</span></span>\n                </div>\n                </div>\n    ");
      });
...
//UI variables
var textInput = document.querySelector(".search__form--search-box"); //Create new search and ui instance

var search = new _Search.default();
var ui = new _searchView.default(); //call searchUsers and handle data

textInput.addEventListener("keyup", function (e) {
  //Capture input data
  var userInput = textInput.value; //If there is an input make http request and handle data

  if (userInput !== "") {
    search.searchUsers(userInput).then(function (res) {
...
},{"./scss/main.scss":"../src/scss/main.scss","./models/Search":"../src/models/Search.js","./views/searchView":"../src/views/searchView.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
